/*
 * CSC 17B  Example 5 Threading Program
 * Purpose:  Using a mutex, i.e. a variable
 *      used by all threads
 */
...
int main (int argc, char *argv[]){
    ...
    a = new float[NUMTHRDS*VECLEN];
    b = new float[NUMTHRDS*VECLEN];
